...
from app.services.ingestion.data_ingestion import import_organization_folder
from app.services.ingestion.dataset_validation import ROOT
from tests.integration.test_ingestion import fixture, write_fixture
...
class BackendContractTests(unittest.TestCase):
    ...
    def test_behaviour_rules_in_shared_and_case_feeds(self):
        from app.models import Alert, Case, Investigation
    ...
    def test_session_closes_on_exception(self):
        mock=MagicMock()
        with patch('app.core.database.SessionLocal',return_value=mock):
