...
from app.services.analytics.workflow_auditor import (
...
class WorkflowAuditorTests(unittest.TestCase):
    ...
    @patch('app.services.analytics.workflow_auditor._load_rows', return_value=[])
    ...
    @patch('app.services.analytics.workflow_auditor._load_rows')
