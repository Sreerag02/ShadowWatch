> Historical handoff, preserved for provenance. Its paths and implementation claims describe the original submission. Use [current behaviour documentation](behaviour_analytics.md) and [current structure](project_structure.md) for maintained commands and verification.
